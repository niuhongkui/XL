...
#pragma warning disable 1066,1570,1573,1591
    ...
    public class Database : IDatabase
    {
        ...
        public List<T> SkipTake<T>(long skip, long take,out string sqlCount, string sql, params object[] args)
        {
            string  sqlPage;
            BuildPageQueries<T>(skip, take, sql, ref args, out sqlCount, out sqlPage);
            return Fetch<T>(sqlPage, args);
        ...
        public List<T> SkipTake<T>(long skip, long take, Sql sql, out string sqlCount)
        {
            return SkipTake<T>(skip, take,out sqlCount, sql.SQL, sql.Arguments);
        }
        #endregion
