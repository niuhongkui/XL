...
namespace XL.Framework.Utility
{
    ...
    public class Encrypt
    {
        ...
        public static string Encode(string encryptString, string encryptKey = "www.XL.com")
        {
        ...
        public static string Decode(string decryptString, string decryptKey = "www.XL.com")
        {
            try
            {
